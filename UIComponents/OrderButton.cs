...
namespace KLEVACUBE.UIComponents
{
    public class OrderButton
    {
        ...
        {
            string attributeList = string.Format(@"href=""https://klevarange.com.au/products/cube-cutter-vegetable-chopper-slicer-dicer-buy-1-get-1-free"" class=""{0}""{1}", classList ?? ClassList, ApplyAttributes());
